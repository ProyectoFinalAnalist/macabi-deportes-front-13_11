            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="pointer">
                    <tr v-for="socio in sociosFiltados" :key="socio.idSocio">
                        ...
                        <td @click="irA(socio.idSocio)" >{{ socio.nombre }}  <label class="btn-group" id="socioNuevo" v-if="socio.esNuevoSocio">"NUEVO"</label>  </td>
                        <td @click="irA(socio.idSocio)">{{ socio.apellido }}</td>
                        <td @click="irA(socio.idSocio)" class="d-none d-sm-table-cell">{{ socio.dni }}</td>
                        <td><button @click="eliminarSocio(socio.idSocio)" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
