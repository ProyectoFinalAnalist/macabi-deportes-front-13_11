        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr v-for="(socio, index) in sociosList" :key="socio.idSocio">
              ...
              <td><button class="btn btn-danger" @click="eliminarDeListaSocios(index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
